...
plt.tight_layout()
plt.savefig('figures/Response_to_random_input_inputs',dpi=300)
...
plt.tight_layout()
plt.legend()
plt.savefig('figures/Response_to_random_input_autocorrelation',dpi=300)
...
plt.tight_layout()
plt.legend()
plt.savefig('figures/Response_to_random_input_PSD',dpi=300)
